...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-900 dark:text-gray-100">
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-100 dark:bg-gray-900 overflow-hidden">
            ...
            <aside 
                class="fixed inset-y-0 left-0 z-30 w-64 bg-gray-800 text-white transition-transform duration-300 transform flex flex-col shadow-lg lg:static lg:translate-x-0"
            ...
            <div class="flex-1 flex flex-col min-w-0 overflow-hidden bg-gray-100 dark:bg-gray-900">
                ...
                <header class="bg-white dark:bg-gray-800 shadow-sm z-10 shrink-0 border-b border-gray-100 dark:border-gray-700">
