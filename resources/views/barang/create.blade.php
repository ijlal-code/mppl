                ...
                <form method="POST" action="{{ route('barang.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="kode_barang" class="block mt-1 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg" type="text" name="kode_barang" :value="old('kode_barang')" required autofocus placeholder="Contoh: BRG-001" />
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_barang" class="block mt-1 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg" type="text" name="nama_barang" :value="old('nama_barang')" required placeholder="Nama lengkap barang" />
                            <x-input-error :messages="$errors->get('nama_barang')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="kategori" value="Kategori" class="text-gray-700 font-bold" />
                            <x-text-input id="kategori" class="block mt-1 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg" type="text" name="kategori" :value="old('kategori')" required />
                            <x-input-error :messages="$errors->get('kategori')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="satuan" value="Satuan (Misal: Kg, Pcs, Box)" class="text-gray-700 font-bold" />
                            <x-text-input id="satuan" class="block mt-1 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg" type="text" name="satuan" :value="old('satuan')" required />
                            <x-input-error :messages="$errors->get('satuan')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="stok" value="Jumlah Stok" class="text-gray-700 font-bold" />
                            <x-text-input id="stok" class="block mt-1 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg" type="number" name="stok" :value="old('stok')" required />
                            <x-input-error :messages="$errors->get('stok')" class="mt-2" />
                        </div>

                         <div>
                            <x-input-label for="harga" value="Harga (Rp)" class="text-gray-700 font-bold" />
                            <x-text-input id="harga" class="block mt-1 w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-lg" type="number" step="0.01" name="harga" :value="old('harga')" required />
